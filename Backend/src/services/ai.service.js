...
const interviewReportSchema = {
    ...
    properties: {
        ...
        matchScore: { type: SchemaType.NUMBER, description: "Match percentage 0 to 100" },
        technicalQuestions: {
    ...
    required: ["jobDescription", "resume", "matchScore", "technicalQuestions", "behavioralQuestions", "skillGaps", "preparationPlan"]
};

async function generateInterviewReport(resumeText, selfDescription, jobDescriptionText) {
...
async function generatePdfFromHtml(htmlContent) {
    ...
    try {
        ...
        // Give extra time for fonts/rendering
        ...
        generationConfig: {
            ...
            responseSchema: {
                ...
                properties: {
                    html: {
                        type: SchemaType.STRING,
                        description: "Complete self-contained HTML for a professional resume"
                    }
                },
                required: ["html"]
            }
